...
public class RepelNode extends Sprite {

    public RepelNode(Vector2D location, Vector2D velocity, Vector2D acceleration, double width, double height) {
    ...
    public Node createView() {
        ...
        circle.setFill(Color.LIGHTCYAN.deriveColor(1, 1, 1, 0.3));
    ...
    public Vector2D repel(Particle particle) {
        ...
        // calculate magnitude
        double force = -1.0 * Settings.REPELLER_STRENGTH / (distance * distance); // repelling force is inversely
